...
class Trader:
    ...
    def run(self, state: TradingState):
        ...
        if best_ask is not None and best_ask < ema_hp - TAKE_EDGE: #and pos > MAX_TAKE_SHORT:
        ...
        if best_bid is not None and best_bid > ema_hp + TAKE_EDGE: # and pos < MAX_TAKE_LONG:
